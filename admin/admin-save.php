...
if(isset($_GET['runnow'])){
	...
	include_once("importtools/amazon_api_class.php");	
...
if(isset($_POST['icodes_update_categorylist'])){
...
if(isset($_POST['icodes_update_networklist'])){
...
if(isset($_POST['icodes_update_merchantlist'])){
...
/********************************* SHOPPERPRESS SPECIAL OPTIONS *************************/
	...
	if(isset($_POST['price'])){
		$check_right = (int)trim($_POST['enable_priceshipping']);
		update_option("enable_priceshipping", $check_right);
	}
	// if setup
