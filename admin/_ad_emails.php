...
<?php }else{ ?>
	...
	<tr class="mainrow" id="email_box" style="display:visible">
       ...
       <!-- <small>Custom values include  (ID), (username), (email), (website), (firstname), (lastname), (created), (nickname) </small>-->
		</td>
	</tr>
...
<br /><small>Short tags: (username), (firstname), (lastname), (email) </small>
...
case "auctionpress": {
 ...
 ?>
     	...
     	<tr class="mainrow">
		<td class="titledesc"><br />New Auction Item</td>

		<td class="forminp">
			<select name="adminArray[email_auction_new]" style="width: 400px;  font-size:14px;">
			<option value="0">---------</option>
     	...
     	<tr class="mainrow">
		<td class="titledesc"><br />Make New Bid
        
        
        </td>

		<td class="forminp">
			<select name="adminArray[email_bid_new]" style="width: 400px;  font-size:14px;">
			<option value="0">---------</option>
      	...
      	<tr class="mainrow">
		<td class="titledesc"><br />Auction Ended</td>

		<td class="forminp">
			<select name="adminArray[email_auction_end]" style="width: 400px;  font-size:14px;">
			<option value="0">---------</option>
