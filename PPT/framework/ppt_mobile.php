...
function _check(){
        ...
        $mobile = false;
        $agents = array("Alcatel", "Blackberry", "HTC", "HP", "LG", "Motorola", "Nokia", "Palm", "Samsung", "SonyEricsson", "ZTE", "Mobile", "iPhone", "iPod", "iPad", "Mini", "Playstation", "DoCoMo", "Benq", "Vodafone", "Sharp", "Kindle", "Nexus", "Windows Phone");
        foreach($agents as $a){
	...
	switch($_GET['show']){
		...
		case "contact": {		
            ...
            $STRING .= ' <form action="" method="post"> 
                    ...
                    <label>Message:</label>
                    <textarea class="form_textarea" name="form[comments]"></textarea>
