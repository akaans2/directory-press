...
<div id="premiumpress_tab1" class="content">
	...
	<a href="<?php echo $result['files'][$currThumb] ?>" rel="image_group">
	...
	<input type="hidden" name="d<?php echo $checkbox; ?>-id" value="<?php echo $result['files'][$currThumb]; ?>">
