	...
	<tr class="mainrow">
		...
		<p><b>SUB Categories</b></p>			
			...
			<select name="adminArray[display_sub_categories]" style="width: 240px;  font-size:14px;">
                ...
                <?php if(get_option("display_themecolumns") =="3"){ ?><option value="left" <?php if(get_option("display_categories") =="left"){ print "selected";} ?>>Show - Left Sidebar</option><?php } ?>
...
<tr class="mainrow"> <td></td><td class="forminp">
		...
		<p><b> Enable Slider </b></p>			
			...
			<small>Enable the home page featured slider.</small>
...
<input name="admin_slider" type="hidden" value="slider" />
 ...
 <table width="100%" border="0">
  ...
  <tr>
    <td><b>Slider Image</b> <small>(650x X 265px)</small><br/> <input type="text" name="s2" id="pps2"  style="width: 200px;  font-size:14px;" class="txt" />
