...
<p><b>Secure File Download Path</b></p>
...
<p><b>Display Price Format</b></p>
			...
			<select name="adminArray[display_currency_format]" style="width: 240px;  font-size:14px;">
                ...
                <option value="2" <?php if(get_option("display_currency_format") =="2"){ print "selected";} ?>>2 (eg. $100.00)</option>
