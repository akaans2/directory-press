...
(function($) {
  $.fn.adGallery = function(options) {
    var defaults = { loader_image: '../wp-content/themes/directorypress/PPT/img/loader.gif',
                     start_at_index: 0,
  ...
  AdGallery.prototype = {
    ...
    _showWhenLoaded: function(index, callback) {
      if(this.images[index]) {
        ...
        if(image.link) {
          var link = jQuery('<a href="'+ image.link +'" target="_blank"></a>');
          link.append(img);
  ...
  AdGallerySlideshow.prototype = {
    ...
    create: function() {
      this.start_link = jQuery('<span class="ad-slideshow-start">'+ this.settings.start_label +'</span>');
      this.stop_link = jQuery('<span class="ad-slideshow-stop">'+ this.settings.stop_label +'</span>');
      this.countdown = jQuery('<span class="ad-slideshow-countdown"></span>');
