...
$gatway[7]['name'] 	= "Protx / SegPay Setup";
$gatway[7]['function'] 	= "gateway_protx";
$gatway[7]['website'] 	= "http://www.segpay.com";
...
function gateway_protx($data=""){
	...
	** You can change this for each transaction, perhaps passing a session ID or state flag if you wish */
	...
	$strPost=$strPost . "&CustomerName=" . $data['billing']['fname'] . " " . $data['billing']['lname'];
 
	// Billing Details:
	$strPost=$strPost . "&BillingFirstnames=" . $data['billing']['fname'];
	$strPost=$strPost . "&BillingSurname=" . $data['billing']['lname'];
	$strPost=$strPost . "&BillingAddress1=" . $data['billing']['address1'];
	 
	$strPost=$strPost . "&BillingCity=" . $data['billing']['city'];
	$strPost=$strPost . "&BillingPostCode=". $data['billing']['zip'];
	$strPost=$strPost . "&BillingCountry=GB"; //$data['billing']['country']
	
	// Delivery Details:
	$strPost=$strPost . "&DeliveryFirstnames=" . $data['billing']['fname'];
	$strPost=$strPost . "&DeliverySurname=" . $data['billing']['lname'];
	$strPost=$strPost . "&DeliveryAddress1=" . $data['billing']['address1'];
	$strPost=$strPost . "&DeliveryCity=" . $data['billing']['city'];
	$strPost=$strPost . "&DeliveryPostCode=". $data['billing']['zip'];
...
function gateway_ccavenue($data=""){
	...
	$Amount = $data['price']['total'] ;//your script should substitute the amount in the quotes provided here
...
<input type='hidden' name='total' value='".$data['price']['total']."' >
...
<p class="f_half left"> 
<label class="col1">City:</label><br />
<span class="col2"><input  class="mid2" type=text size=25 maxlength=40 name="custom[city]" value="<?php echo $data['billing']['city']; ?>"></span>
</p>
<p class="f_half left"> 
<label class="col1">State:</label><br />
<span class="col2"><select  class="mid2" id=state name="custom[state]">
				<option value=""  selected></option>
				<option value=AK>AK</option>
				<option value=AL>AL</option>
				<option value=AR>AR</option>
...
$amount 		= str_replace(".","",$data['price']['total'])*10;
