...
if(is_home() && !isset($_GET['s']) && !isset($_GET['search-class']) ){
	...
	}else{  $query_string = str_replace("&post_type=post","",str_replace("&orderby=meta_value","",str_replace("&meta_key=featured","",$query_string)));  $GLOBALS['setflag_faq']=1;  } 
	}else{  $query_string = str_replace("&post_type=post","",str_replace("&orderby=meta_value","",str_replace("&meta_key=featured","",$query_string))); $GLOBALS['setflag_article']=1; } // STRIPS TYPE POST FOR ARTICLES
