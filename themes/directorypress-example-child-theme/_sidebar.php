...
<?php echo example_function_name("_sidebar.php"); ?>
...
<?php }else{ ?>
	...
	<a href="<?php echo get_option('submit_url'); ?>" class="btnDownload_01 r10 rb10"><strong><?php echo SPEC($GLOBALS['_LANG']['_side13']) ?></strong><span><?php echo SPEC($GLOBALS['_LANG']['_side14']) ?></span></a> 
