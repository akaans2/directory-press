...
<?php echo example_function_name("_tpl_myaccount.php"); ?> 
...
<p class="f_half left"> 
    <label for="email"><?php echo SPEC($GLOBALS['_LANG']['_tpl_myaccount23']) ?> <span class="required">*</span></label><br /> 
    <input type="text" name="address[state]" value="<?php echo $ADD[1]; ?>" class="short" tabindex="15" /><br /> 
